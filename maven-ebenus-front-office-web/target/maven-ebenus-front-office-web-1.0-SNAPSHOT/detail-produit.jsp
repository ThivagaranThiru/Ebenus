		    ...
		    <ul class="main-menu">
		    	...
		    	<li class="last">
					...
					<ul class="sub-menu">
						...
						<li><a href="PanierContent">Panier</a></li>
						<li><a href="creer-compte-client.html">CrÃ©er Compte</a></li>
						</ul>
						</li>
        ...
        <div>
            <div class="price-box">
                <span class="regular-price" id="product-price-101">
                    <span class="price">${model.produit.prix}</span>
                </span>
            </div>
            <p class="reference-product">Ref : <strong>${model.produit.reference}</strong></p>
            <div class="availability in-stock">Availability: <span>${model.produit.stock}</span>
            <input type = "hidden" id = "stk" value ="${model.produit.stock}"/>
                <p>Nous nous excusons de lâindisponibilitÃ© du produit, il sera bientÃ´t disponible sous X semaines.</p>
            </div>
        </div>
    </div>
