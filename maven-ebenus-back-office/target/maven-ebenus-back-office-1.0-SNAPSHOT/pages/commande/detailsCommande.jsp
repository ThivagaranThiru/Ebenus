<%-- 
    ...
    Created on : 8 avr. 2019, 19:32:54
    Author     : thiva
--%>
          ...
          <table class="table">
            ...
            <tr>
              <th>Date modification commande</th>
                <td>${commande.dateModification}</td>
                
            </tr>
            <tr>
              <th>Statut du commande</th>
                <td><c:choose>
                        <c:when test="${commande.statut=='V'}">
                            Valide
                        </c:when>
                        <c:otherwise>
                            En Attente
      ...
      <div class="panel panel-default">
        <div class="panel-heading">Informations compte</div>
          <table class="table">
            ...
            <tr>
              <th>Client</th>
                <td>${commande.utilisateur.civilite} ${commande.utilisateur.nom} ${commande.utilisateur.prenom} </td>
                
            </tr>
            <tr>
              <th>Identifiant</th>
                <td>${commande.utilisateur.identifiant} </td>
    ...
    <div class="col-md-6">
      <div class="panel panel-default">
        <div class="panel-heading">Adresse de facturation</div>
          <p>
           ${commande.adresse.rue} ${commande.adresse.codePostal} ${commande.adresse.ville}, ${commande.adresse.pays}
          </p>
      </div>
    </div>
    <div class="col-md-6">
  ...
  <div class="row">
    ...
    <!-- /#page-wrapper -->
        <div class="row">
            ...
            <a href="AllCommandesServlet" class="btn btn-default btn-lg pull-right"><span><i class="fa fa-arrow-left"></i>Retour</span></a>
