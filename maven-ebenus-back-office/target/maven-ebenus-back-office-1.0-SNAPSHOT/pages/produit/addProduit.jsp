<%-- 
    Document   : addProduit
    Created on : 7 avr. 2019, 23:39:33
    Author     : thiva
--%>
  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      <div class="container-fluid">
        ...
        <!-- /.row -->
         <form method="post" action="AddProduitServlet" class="form-horizontal">
         <div class="row">
         ...
         <div class="row">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                <input id="nomPorduit" name="nomProduit" type="text" placeholder="" class="form-control input-md" required="">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                <input id="prix" name="prix" type="number" placeholder="" step="0.01" class="form-control input-md" required="">                  
                </div>
              </div>
