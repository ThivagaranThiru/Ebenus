<%-- 
    Document   : updateRole
    Created on : 7 avr. 2019, 19:25:58
    Author     : thiva
--%>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active">
                <i class="fa fa-edit"></i> Editer Rôle
              </li>
            </ol>
          </div>
        </div>
        <!-- /.row -->
      <form method="post" action="UpdateRoleServlet" class="form-horizontal">
         <div class="row">
         ...
         <div class="row">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                <input id="idRole" name="idRole" type="text" placeholder="" class="form-control input-md" value="${roleUpdate.identifiant}" required="">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <textarea rows="7" class="form-control input-md" name="desRole" id="desRole" required="">${roleUpdate.description}</textarea>
                </div>
              </div>
