<%-- 
    ...
    Created on : 8 avr. 2019, 00:20:20
    Author     : thiva
--%>
  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      <div class="container-fluid">
        ...
        <!-- /.row -->
         <form method="post" action="UpdateProduitServlet" class="form-horizontal">
         <div class="row">
            <div class="well well-lg clearfix text-right">
              <a href="AllProduitsServlet" class="btn btn-lg "><span><i class="fa fa-arrow-left"></i>Retour</span></a>
         ...
         <div class="row">
              ...
              <div class="form-group">
                ...
                <div class="col-md-3">
                <div class="checkbox">
                    <input type="checkbox" ${checked} name="checkboxes" id="checkboxes-0" >
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                <input id="reference" value="${updateProduit.reference}" name="reference" type="text" placeholder="" class="form-control input-md" required="">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                <input id="nomProduit" value="${updateProduit.nom}" name="nomProduit" type="text" placeholder="" class="form-control input-md" required="">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                <input id="prix" value="${updateProduit.prix}" name="prix" type="number" step="0.01" placeholder="" class="form-control input-md" required="">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                 <input id="stock" value="${updateProduit.stock}" name="stock" type="number" placeholder="" class="form-control input-md" required="">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">                     
                  <textarea class="form-control" id="textarea" name="description" rows="6">${updateProduit.description}</textarea>
                </div>
              </div>
              </fieldset>
         </div>
