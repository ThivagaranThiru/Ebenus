<%-- 
    Document   : dashboard
    Created on : 5 avr. 2019, 19:23:44
    Author     : thiva
--%>
  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="${pageContext.request.contextPath}/DashboardServlet">Ebenus Admin</a>
      </div>
      <!-- Top Menu Items -->
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
          <li class="active">
            <a href="${pageContext.request.contextPath}/DashboardServlet"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
          </li>
          <li>
              ...
              <div class="panel-body">
                <div class="table-responsive">
                  <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                     <c:forEach items="${articleCommandeList}" var="articleCommandeList">
                      <tr>
                        <td>${articleCommandeList.idArticleCommande}</td>
                        <td><fmt:formatDate value="${articleCommandeList.dateModification}" pattern="yyyy-MM-dd" /></td>
                        <td><fmt:formatDate value="${articleCommandeList.dateModification}" pattern="ss:mm:HH" /></td>
                        <td>€ ${articleCommandeList.totalArticleCommande}</td>
                      </tr>
                     </c:forEach>
                    </tbody>
                  </table>
